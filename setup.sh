...
chmod +x $HOME/LINUX_SETUP/gitclone.sh
chmod +x $HOME/LINUX_SETUP/desktop_customization.sh
chmod +x $HOME/LINUX_SETUP/grubtheme.sh
chmod +x $HOME/LINUX_SETUP/visit_sites.sh
